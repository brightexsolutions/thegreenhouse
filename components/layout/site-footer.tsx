...
import { whatsappUrl, SITE_NAME, SESSION_FREQUENCY, SOCIAL_INSTAGRAM, SOCIAL_TIKTOK, SOCIAL_YOUTUBE, SOCIAL_FACEBOOK, SOCIAL_TWITTER } from "@/lib/constants";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              {SOCIAL_INSTAGRAM && (
                <li>
                  <a href={SOCIAL_INSTAGRAM} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">Instagram</a>
                </li>
              )}
              {SOCIAL_TIKTOK && (
                <li>
                  <a href={SOCIAL_TIKTOK} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">TikTok</a>
                </li>
              )}
              {SOCIAL_YOUTUBE && (
                <li>
                  <a href={SOCIAL_YOUTUBE} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">YouTube</a>
                </li>
              )}
              {SOCIAL_FACEBOOK && (
                <li>
                  <a href={SOCIAL_FACEBOOK} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">Facebook</a>
                </li>
              )}
              {SOCIAL_TWITTER && (
                <li>
                  <a href={SOCIAL_TWITTER} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">X / Twitter</a>
                </li>
              )}
              <li>
