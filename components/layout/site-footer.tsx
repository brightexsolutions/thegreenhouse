        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              {socials.instagram && (
                <li>
                  <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">
                    Instagram
                  </a>
                </li>
              )}
              {socials.tiktok && (
                <li>
                  <a href={socials.tiktok} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">
                    TikTok
                  </a>
                </li>
              )}
              {socials.youtube && (
                <li>
                  <a href={socials.youtube} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">
                    YouTube
                  </a>
                </li>
              )}
              {socials.facebook && (
                <li>
                  <a href={socials.facebook} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">
                    Facebook
                  </a>
                </li>
              )}
              {socials.twitter && (
                <li>
                  <a href={socials.twitter} target="_blank" rel="noopener noreferrer" className="text-cream/60 hover:text-cream transition-colors">
                    X / Twitter
                  </a>
                </li>
              )}
